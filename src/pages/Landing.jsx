    ...
    <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-sans transition-colors h-screen overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md shadow-lg z-50 transition-colors duration-200">
        <div className="flex items-center justify-between px-6 sm:px-10 py-5 max-w-7xl mx-auto">
          ...
          <button 
            className="md:hidden bg-gray-100 dark:bg-gray-800 p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden fixed top-16 left-0 right-0 bg-white dark:bg-gray-900 shadow-xl transform origin-top transition-all duration-300 ease-out ${
          isMenuOpen ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0 pointer-events-none'
        }`}>
          <div className="px-6 py-4 space-y-6 border-t border-gray-100 dark:border-gray-800">
            <nav className="flex flex-col space-y-4">
              <Link 
                to="/" 
                className="flex items-center py-2 px-4 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-all group"
                onClick={() => setIsMenuOpen(false)}
              >
                <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-[#A31621] dark:group-hover:text-[#FF6B7D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              to="/signup"
              className="block w-full text-center py-3 px-6 rounded-lg bg-[#A31621] dark:bg-[#FF4757] text-white font-medium hover:bg-opacity-90 transition shadow-md hover:scale-[1.02] transform"
              onClick={() => setIsMenuOpen(false)}
            >
              Get Started
            </Link>
