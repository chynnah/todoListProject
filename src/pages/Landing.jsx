  ...
  return (
    <div className=" bg-white text-gray-900 ">
      <header className="flex items-center justify-between flex-wrap px-6 sm:px-10 py-6 max-w-7xl mx-auto mt-[-40px]">
        <img src={logo} alt="ListAll logo" className="h-30 w-auto mt-3" />
      ...
      <section className="text-center py-24 px-6 font-sans">
        ...
        <button className="bg-[#FF1654] text-white px-8 py-3 rounded-[50px] text-[30px] ">
          Get Started
        </button>
      </section>
      ...
      <section id="features" className="bg-gray-50 py-20 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto text-center">
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-semibold">Create a List in Seconds</h4>
            <p className="text-gray-600">Add tasks effortlessly with one click or tap.</p>
          </div>
          <div className="space-y-4">
            <div className="text-4xl">✅</div>
            <h4 className="text-xl font-semibold">Track Your Progress</h4>
            <p className="text-gray-600">Check off completed tasks and stay on track.</p>
          </div>
          <div className="space-y-4">
            <div className="text-4xl">🧘‍♂️</div>
            <h4 className="text-xl font-semibold">Stay Focused</h4>
            <p className="text-gray-600">A clean, distraction-free interface for better productivity.</p>
          </div>
        </div>
      </section>
      ...
      <section className="text-center py-20 px-6">
        <h4 className="text-2xl font-bold mb-4">Ready to get organized?</h4>
        <p className="text-gray-600 mb-6">
          Start using ListAll and manage your life with ease.
        </p>
        <button className="bg-sky-600 text-white px-6 py-3 rounded-lg text-lg hover:bg-sky-700 transition">
          Try ListItAll Now
        </button>
      </section>
      ...
      <footer className="bg-gray-900 text-gray-400 text-center py-10 text-sm">
        ...
        <p>© 2025 ListItAll. All rights reserved.</p>
      </footer>
    </div>
  );
};
